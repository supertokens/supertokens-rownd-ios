...
The release command bumps `VERSION`, `Sources/Rownd/framework/Version.swift`, and `RowndSupertokens.podspec`, creates a GitHub release with a `vX.Y.Z` tag, validates the podspec, and publishes `RowndSupertokens` to CocoaPods.
