...
ALLOWED_ORIGINS=https://rownd-hub.supertokens.com,http://127.0.0.1:5173,http://localhost:5173
...
ROWND_MOBILE_CLIENT_DOMAIN=https://rownd-hub.supertokens.com/
```
...
ROWND_EXAMPLE_HUB_BASE_URL=https://rownd-hub.supertokens.com
...
The example app uses Universal Links for authentication links hosted on `https://rownd-hub.supertokens.com`.
